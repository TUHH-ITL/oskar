#!/usr/bin/env python3
"""Real robot launch file for Phase 2 pruning pipeline."""
...
def generate_launch_description():
    """Generate launch description for Phase 2 pruning (real robot)."""
    oskar_pruning_share = FindPackageShare("oskar_pruning")
    config_dir = PathJoinSubstitution([oskar_pruning_share, "config"])
    params_file = PathJoinSubstitution([config_dir, "pruning_params.yaml"])
